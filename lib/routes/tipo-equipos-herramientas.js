...
router.get('/tipo-equipos-herramientas', isLoggedIn, async (req, res) => {
  ...
  res.render('tipo-equipos-herramientas/tipo-equipos-herramientas', {
    tipo_equipos_herramietas
  });
});
...
router.get('/editar-tipo-equipos-herramientas/:id_tipo_equipo_herramienta', isLoggedIn, async (req, res) => {
  ...
  res.render('tipo-equipos-herramientas/editar', {
    tipo_equipos_herramientas: tipo_equipos_herramientas[0]
  });
});
