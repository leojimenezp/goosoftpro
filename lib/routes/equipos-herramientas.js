...
router.get('/equipos-herramientas', isLoggedIn, async (req, res) => {
  ...
  res.render('equipos-herramientas/equipos-herramientas', {
    equipos
  });
});
router.get('/equipos-herramientas/crear', isLoggedIn, async (req, res) => {
  ...
  res.render('equipos-herramientas/crear', {
    proveedor,
    tipo_equipos_herramientas
  });
});
...
router.get('/editar-equipo-herramienta/:id_equipo', isLoggedIn, async (req, res) => {
  ...
  res.render('equipos-herramientas/editar', {
    equipo: equipo[0],
    proveedor,
    tipo_equipos_herramientas
  });
