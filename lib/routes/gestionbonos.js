...
router.post('/gestionbonos/agregar-bono-sin-planeacion1', isLoggedIn, async (req, res) => {
  ...
  if (tipo_de_bono == '1') {
    ...
    await pool.query(`INSERT INTO tb_gestion_bonos(
        ...
        valor_bono_total,
        cantidad_festivos) 
        VALUES(?,?,?,?,?,?,?,?,?,?,?)`, [id_personal, centro_costo, fecha_final, tipo_de_bono, fecha_inicio, fecha_inicio, id_planeacion, bono_trasporte[0].total, dias[0].dias + 1, bono_trasporte[0].total * (dias[0].dias + 1), festivosss]);
    ...
    await pool.query(`INSERT INTO tb_gestion_bonos(
        ...
        VALUES(?,?,?,?,?,?,?,?,?,?,?)`, [id_personal, centro_costo, fecha_final, tipo_de_bono, fecha_inicio, fecha_inicio, id_planeacion, bono_de_campo[0].bono_salarial_personal, dias[0].dias + 1, bono_de_campo[0].bono_salarial_personal * (dias[0].dias + 1), festivosss]);
    ...
    await pool.query(`INSERT INTO tb_gestion_bonos(
        ...
        dias,
        valor_bono_total,cantidad_festivos) 
        VALUES(?,?,?,?,?,?,?,?,?,?,?)`, [id_personal, centro_costo, fecha_final, tipo_de_bono, fecha_inicio, fecha_inicio, id_planeacion, otros, dias[0].dias + 1, otros * (dias[0].dias + 1), festivosss]);
  }
