...
if(porcentaje ==undefined){ porcentaje = 0}
 ...
 if(horas_trabajo ==undefined){ horas_trabajo = 0}
 if( planeacion ==undefined){ planeacion= 0}
 if(gestion_template==undefined){gestion_template= 0}
 if(reportes ==undefined){reportes= 0}
 if(control_costos ==undefined){control_costos= 0}
 if(consignaciones ==undefined){consignaciones = 0}
 if(permiso_aceptar ==undefined){permiso_aceptar = 0}
 if(legalizacion ==undefined){ legalizacion = 0}
 if( gestion_bonos==undefined){ gestion_bonos = 0}
 if( reportes_costos ==undefined){ reportes_costos= 0}
 if(movilizacion ==undefined){movilizacion = 0}
 if(aprobacion ==undefined){aprobacion= 0}
 if(ctrl_movilizacion==undefined){ctrl_movilizacion= 0}
 if(consultas==undefined){ consultas = 0}
 if(configuracion_general==undefined){ configuracion_general= 0}
 if( cargos ==undefined){  cargos = 0}
 if( clientes ==undefined){ clientes = 0}
 if( contratos ==undefined){contratos= 0}
 if( campos ==undefined){campos = 0}
 if(centro_costos ==undefined){ centro_costos = 0}
 if( equipo_herramienta ==undefined){equipo_herramienta = 0}
 if( item ==undefined){item= 0}
 if( moneda ==undefined){ moneda = 0}
 if( personal ==undefined){personal = 0}
 if( proveedores ==undefined){proveedores= 0}
 if( pozos==undefined){ pozos= 0}
 if( rubros==undefined){rubros= 0}
 if( tipo_trabajos ==undefined){tipo_trabajos= 0}
 if(tipo_pozos ==undefined){ tipo_pozos= 0}
 if(tipo_equipos==undefined){ tipo_equipos= 0}
 if( usuarios==undefined){ usuarios= 0}
 if(unidad_medida==undefined){unidad_medida= 0}
