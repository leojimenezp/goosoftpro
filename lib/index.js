...
app.use(fileUpload()); // Global variables
...
app.use(require('./routes/reporteEjecutadoPlaneado')); // Public

app.use(express.static(path.join(__dirname, 'public')));
app.use(express.static(path.join(__dirname, 'download')));
app.use(express.static(path.join(__dirname, 'views/js'))); // Starting
