...
(function (c) {
  "function" === typeof define && define.amd ? define(["jquery", "datatables.net-zf", "datatables.net-buttons"], function (a) {
    ...
    a || (a = window);b && b.fn.dataTable || (b = require("datatables.net-zf")(a, b).$);b.fn.dataTable.Buttons || require("datatables.net-buttons")(a, b);return c(b, a, a.document);
  } : c(jQuery, window, document);
})(function (c, a, b, d) {
  a = c.fn.dataTable;c.extend(!0, a.Buttons.defaults, { dom: { container: { tag: "div", className: "dt-buttons button-group" },
