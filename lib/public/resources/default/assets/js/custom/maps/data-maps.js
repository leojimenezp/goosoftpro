(function ($) {
    ...
    dataMapArc.arc([{ origin: 'IND', destination: 'RUS' }, { origin: 'IND', destination: 'USA' }, { origin: 'IND', destination: 'DEU' }, { origin: 'IND', destination: 'POL' }, { origin: 'IND', destination: 'JAP' }, { origin: 'IND', destination: 'AUS' }, { origin: 'IND', destination: 'BRA' }], { strokeColor: '#512DA8', strokeWidth: 2 });
})(jQuery);