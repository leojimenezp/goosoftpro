(function ($) {
  ...
  new Chart(ctxDoughnutPattern, {
    ...
    data: {
      ...
      datasets: [{
        data: [65, 59, 80, 81, 56, 55, 40],
        backgroundColor: [pattern.draw('square', '#ff6384'), pattern.draw('circle', '#3367d6'), pattern.draw('dot', '#FF901F'), pattern.draw('diamond', '#cc65fe'), pattern.draw('zigzag-horizontal', '#17becf'), pattern.draw('line-vertical', '#ffc658'), pattern.draw('triangle', '#59AA2B')]
      }]
    },
  ...
  new Chart(ctxDoughnutChart, {
    ...
    data: {
      ...
      datasets: [{
        data: [65, 59, 80, 81, 56, 55, 40],
        backgroundColor: ['#ff6384', '#3367d6', '#FF901F', '#cc65fe', '#17becf', '#ffc658', '#59AA2B']
      }]
    },
  ...
  var pieChart = new Chart(ctxPieChart, {
    ...
    data: {
      ...
      datasets: [{
        data: [65, 59, 90, 81, 56, 55, 40],
        backgroundColor: ['rgba(255, 99, 132, .5)', 'rgba(255, 159, 64, .5)', 'rgba(255, 205, 86, .5)', 'rgba(75, 192, 192, .5)', 'rgba(54, 162, 235, .5)', 'rgba(153, 102, 255, .5)', 'rgba(201, 203, 207, .6)']
      }]
    },
  ...
  new Chart(ctxPiePattern, {
    ...
    data: {
      ...
      datasets: [{
        data: [65, 59, 90, 81, 56],
        backgroundColor: [pattern.draw('square', '#ff6384'), pattern.draw('circle', '#3367d6'), pattern.draw('dot', '#FF901F'), pattern.draw('diamond', '#cc65fe'), pattern.draw('zigzag-horizontal', '#17becf')]
      }]
    },
  ...
  new Chart(ctxPolarChart, {
    ...
    data: {
      ...
      datasets: [{
        data: [65, 59, 90, 81, 56],
        backgroundColor: ['rgba(255, 99, 132, .5)', 'rgba(255, 159, 64, .5)', 'rgba(255, 205, 86, .5)', 'rgba(75, 192, 192, .5)', 'rgba(54, 162, 235, .5)'],
  ...
  $('#toggle-view').on('click', function () {
    ...
    if (cogsDynamicChart2.design == 'default') {
      ...
      cogsDynamicChart2.data.datasets[0].backgroundColor = [pattern.draw('square', '#ff6384'), pattern.draw('circle', '#3367d6'), pattern.draw('dot', '#FF901F'), pattern.draw('diamond', '#cc65fe'), pattern.draw('zigzag-horizontal', '#17becf'), pattern.draw('line-vertical', '#ffc658'), pattern.draw('triangle', '#59AA2B')];
      ...
      cogsDynamicChart2.data.datasets[0].backgroundColor = ['rgba(255, 99, 132, .5)', 'rgba(255, 159, 64, .5)', 'rgba(255, 205, 86, .5)', 'rgba(75, 192, 192, .5)', 'rgba(54, 162, 235, .5)', 'rgba(153, 102, 255, .5)', 'rgba(201, 203, 207, .6)'];
