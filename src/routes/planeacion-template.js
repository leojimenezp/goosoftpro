...
router.get('/planeacion/template', isLoggedIn, async (req,res) => {
...
router.get('/planeacion/clonar/:id_planeacion', isLoggedIn, async (req,res) => {
    ...
    const costos_cotizacion = await pool.query(`SELECT * FROM tb_cotizaciones_costos WHERE id_planeacion = '${id_planeacion}'`);

    // datos_equipo_item_consumible
    ...
    // datos_equipo_item_equipo_herramienta
    ...
    // datos_equipo_rubros_equipo_herramienta
