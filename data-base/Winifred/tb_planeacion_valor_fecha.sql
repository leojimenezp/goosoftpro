...
--
-- Dumping data for table `tb_planeacion_valor_fecha`
--

LOCK TABLES `tb_planeacion_valor_fecha` WRITE;
/*!40000 ALTER TABLE `tb_planeacion_valor_fecha` DISABLE KEYS */;
INSERT INTO `tb_planeacion_valor_fecha` VALUES (1,444,2400,'2019-04-01'),(2,333,200,'2019-03-01');
/*!40000 ALTER TABLE `tb_planeacion_valor_fecha` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2020-01-26  0:16:47
